...
export default function Header() {
    ...
    return (
        <header className="sticky top-0 z-50 w-full bg-white shadow-sm dark:bg-primary-content dark:shadow-neutral-800/50">
            {/* DESKTOP HEADER */}
            <div className="hidden md:block">
                <div className="mx-auto max-w-7xl px-4 py-4">
                    <div className="flex h-16 items-center justify-between gap-8">
                        ...
                        <Link
                            href="/"
                            className="shrink-0 text-2xl font-bold text-neutral-900 dark:text-white hover:text-neutral-700 transition-colors joti"
                        >
                            Piwee
                        </Link>
            ...
            <div className="md:hidden">
                <div className="flex h-16 items-center justify-between px-4">
                    {/* Logo */}
                    <Link href="/" className="text-xl font-bold text-neutral-900 dark:text-white joti">
                        Piwee
                    </Link>
